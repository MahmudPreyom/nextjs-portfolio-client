  ...
  return (
    <section id="contact" className="py-16">
      <div className="text-center">
        <h5 className="text-gray-600 text-lg">Get In Touch</h5>
      ...
      <div className="container mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 px-5">
        ...
        <form
          onSubmit={sendEmail}
          className="flex flex-col gap-4 px-8 py-10 rounded-3xl shadow-2xl space-y-4"
        >
          <input
            type="text"
            name="name"
            ...
            required
            className="w-full p-3 bg-transparent border outline-none border-gray-300 rounded-2xl text-black placeholder-gray-400 focus:ring-2"
          />
          <input
            type="email"
            name="email"
...
const ContactOption: React.FC<ContactOptionProps> = ({
  ...
  <div className="p-5 rounded-full shadow-2xl text-center flex flex-col items-center gap-2 transition-transform transform hover:scale-105">
